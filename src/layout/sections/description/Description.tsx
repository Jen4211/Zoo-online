...
import photoMen from "../../../../../Zoo-online/src/assets/bgImg/bamboo-cap.webp"
        ...
        <StyledDescription>
            <Container>
                <DescriptionWrap>
                    ...
                    <TextContainer>
                        <TitleSection color={theme.colors.font.secondary}>The Backstage of the Wilderness
                            World.</TitleSection>
                        <Text color={theme.colors.font.secondary}>The site was founded on the basis of a volunteer
                            movement to protect and care for
                            animals.</Text>
                        <TitleParagraph>How it works </TitleParagraph>
                        <Text color={theme.colors.font.secondary} lineHeight={"140%"}>The main goal is to help the
                            animals, as well as the nature reserves and zoos where they
                            are kept. We are currently working on video projects targeting pandas in China, eagles on an
                            island near Los Angeles, alligators in Florida and gorillas in the Congo. These have a total
                            of more than 1,500 mammals and reptiles.</Text>
                    </TextContainer>
                </DescriptionWrap>
